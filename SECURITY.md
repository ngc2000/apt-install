...
runtime is Ubuntu 24.04 LTS or newer.
...
root filesystem; only regular `.deb` files are accepted and APT validates them
against freshly refreshed, signed repository metadata before installation.
